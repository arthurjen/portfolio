...
function () {
  var _ref = (0, _asyncToGenerator2.default)(function* ({
    ...
    if (store.getState().status.plugins && store.getState().status.plugins[`gatsby-source-contentful`] && store.getState().status.plugins[`gatsby-source-contentful`][`${options.spaceId}-${options.environment}`]) {
      syncToken = store.getState().status.plugins[`gatsby-source-contentful`][`${options.spaceId}-${options.environment}`];
    }
